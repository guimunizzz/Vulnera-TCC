...
| Última atualização | 2026-08-11 por Claude Code (Fase 8 — CP1-4: maturidade completa (backend/frontend/PDF/seed) + ZAP baseline + fix de CI; README/DEMO.md prontos) |
