...
| Métrica            | Valor                               |
| ------------------ | ----------------------------------- |
| Sprint atual       | **Sprint 6 — Relatórios + Dashboards** (concluída) · **Fase 5 endurecida** em 2026-08-07 (branch `fix/fase-5-hardening` aguardando PR) |
| Data início        | 2026-06-10 (Sprint 0)               |
| Data alvo TCC      | 2026-10-25 (11 semanas restantes, ver `docs/BACKLOG.md` v4) |
| Última atualização | 2026-08-07 por Claude Code (sessão de endurecimento da Fase 5) |
