...
| Métrica            | Valor                               |
| ------------------ | ----------------------------------- |
| Sprint atual       | **Fase 8 — Maturidade + TCC** (em andamento; branch `feat/fase-8-maturidade-tcc`; Checkpoints 1-3 concluídos e validados) |
| Data início        | 2026-06-10 (Sprint 0)               |
| Data alvo TCC      | 2026-10-25 (11 semanas restantes, ver `docs/BACKLOG.md` v4) |
| Última atualização | 2026-08-19 por Claude Code (task 8.12 — landing "cyber-samurai" completa: cena Three.js (ASCII + aberração cromática + partículas + lâmina wireframe), glitch, seções novas; ver §6) |
